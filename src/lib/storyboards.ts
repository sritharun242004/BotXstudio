...
export const IMAGE_GENERATION_MODELS = [
  {
    ...
    mode: "Flash Mode",
    tag: "Fast & Affordable",
    desc: "Quick high-quality ecommerce shots · 6 free images · ideal for everyday catalogues",
  ...
  },
  {
    ...
    label: "Plus Model",
    mode: "Plus Workflow",
    tag: "Best Consistency",
    desc: "Flash composition + FLUX Kontext angles · multi-view lookbook · best angle consistency",
  ...
  },
  {
    ...
    mode: "ProMax Mode",
    tag: "Highest Quality",
    desc: "Google's most powerful image model · ultra-detailed outputs · full custom controls",
