...
export const IMAGE_GENERATION_MODELS = [
  {
    ...
    mode: "Flash Mode",
    tag: "Free Included",
    desc: "Fast ecommerce shots with clean lighting and sharp garment detail. Best for high-volume catalogue generation.",
    colorClass: "modelCard--flash",
    provider: "Google Gemini 2.5 Flash",
    tokenBadge: "Gemini 2.5 Flash",
    freeEligible: true,
  },
  {
    id: "hybrid-editorial",
    ...
    desc: "Generates front, back and side angles in one workflow. Ideal for lookbooks needing consistent multi-view sets.",
    colorClass: "modelCard--hybrid",
    provider: "Google × fal.ai FLUX",
    tokenBadge: "Gemini Flash + FLUX",
    freeEligible: false,
  },
  {
    id: "gpt-image-2",
    ...
    mode: "Pro Editorial",
    tag: "Credits Required",
    desc: "Cinematic editorial quality powered by OpenAI GPT-4o vision. Supports medium and high-resolution outputs.",
    colorClass: "modelCard--gpt",
    provider: "OpenAI GPT Image 2",
    tokenBadge: "GPT Image 2",
    freeEligible: false,
  },
  {
    ...
    mode: "ProMax Mode",
    tag: "Free Included",
    desc: "Google's highest-quality image model with ultra-detailed outputs. Full control over styling, pose and lighting.",
    colorClass: "modelCard--pro",
    provider: "Google Gemini 3 Pro",
    tokenBadge: "Gemini 3 Pro",
    freeEligible: true,
  },
] as const;
