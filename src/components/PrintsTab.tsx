      ...
      <div>
              ...
              <>
                ...
                <div className="printsGarmentCards">
                  ...
                  <div className="printsCardSlot">
                    ...
                    {runtime.prints.baseGarmentFrontDataUrl ? (
                      <div className="printsGarmentCard">
                        <img
                        ...
                        />
                        <button type="button" className="atPreviewRemove" onClick={removeBaseGarmentFront} aria-label="Remove" title="Remove">
                          <RemoveIcon />
                        </button>
                      </div>
                    ) : (
                      <label htmlFor="printBaseGarmentFront" className="printsUploadCard">
                        ...
                        <input
                          ...
                          accept="image/*"
                          style={{ display: "none" }}
                          onChange={onBaseGarmentFrontFileChange}
                        />
                      </label>
                    )}
                  </div>
                  ...
                  {!isFullCloth && (
                    <div className="printsCardSlot">
                      <span className="printsCardLabel">Back</span>
                      {runtime.prints.baseGarmentBackDataUrl ? (
                        <div className="printsGarmentCard">
                          ...
                          />
                          <button type="button" className="atPreviewRemove" onClick={removeBaseGarmentBack} aria-label="Remove" title="Remove">
                            <RemoveIcon />
                          </button>
                        </div>
                      ) : (
                        <label htmlFor="printBaseGarmentBack" className="printsUploadCard">
                          ...
                          <input
                            ...
                            accept="image/*"
                            style={{ display: "none" }}
                            onChange={onBaseGarmentBackFileChange}
                          />
                        </label>
                      )}
                    </div>
        ...
        <div className="card" style={{ marginTop: 10 }}>
          ...
          <div className="printsDesignCards">
            {/* Front Design */}
            <div className="printsCardSlot">
              <span className="printsCardLabel">Front</span>
              {runtime.prints.printDesignFrontDataUrl ? (
                <div className="printsDesignCard">
                  <img
                  ...
                  />
                  <button type="button" className="atPreviewRemove" onClick={removePrintDesignFront} aria-label="Remove" title="Remove">
                    <RemoveIcon />
                  </button>
                </div>
              ) : (
            ...
            {!isFullCloth && (
              <div className="printsCardSlot">
                <span className="printsCardLabel">
                  Back <span style={{ fontWeight: 400, fontSize: 10, textTransform: "none" }}>(optional)</span>
                </span>
                {runtime.prints.printDesignBackDataUrl ? (
                  <div className="printsDesignCard">
                    ...
                    />
                    <button type="button" className="atPreviewRemove" onClick={removePrintDesignBack} aria-label="Remove" title="Remove">
                      <RemoveIcon />
                    </button>
                  </div>
                ) : (
