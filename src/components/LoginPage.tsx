      ...
      <div className="auth-card">
        ...
        <div className="auth-form" style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
          ...
          <button
            type="button"
            className="auth-btn"
            onClick={() => redirectToLogin(undefined, true)}
            style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", background: "transparent", border: "2px solid #6366F1", color: "#6366F1" }}
          >
            Create an Account
          </button>
        </div>
